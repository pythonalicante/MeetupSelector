...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    GDPR_accepted: models.BooleanField = models.BooleanField(_("GDPR_accepted"), default=False)
    is_active: models.BooleanField = models.BooleanField(_("is_active"), default=True)
